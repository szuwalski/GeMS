...
PolygonPlots<-function(Truth=NA,Estimated=NA,Observed=NA)
{
 ...
 plot(-100000000000,ylim=c(0,max(EstShape,TrueShape,ObsShape,na.rm=t)),xlim=c(1,SimYear),las=1,ylab="",xlab="Year")
